...
import com.reservationsystem.application.CategoryServiceTest;
...
@Test
    ...
    Category category = Category.builder().name("Good").build();

    given(categoryService.addCategory("Good")).willReturn(category);
    ...
    verify(categoryService).addCategory("Good");
